...
assign USER_OUT[0] = sel_r; //D-
assign USER_OUT[1] = direc_r; //D+
assign USER_OUT[6] = 1'b1; //SSRX- (remember differential pairs swap)
assign USER_OUT[3] = _motor_r; //GND_DRAIN
assign USER_OUT[5] = 1'b1; //SSTX+
assign USER_OUT[2] = _step_r; //SSTX-
...
always @(posedge clk) begin
	_track0_real <= USER_IN[5]; //SSRX+
	_readyreal <= USER_IN[6]; //SSTX-
end
